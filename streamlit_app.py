...
if 'messages' not in st.session_state:
    ...
    if not language_selection: 
        st.image(["https://i.imgur.com/kYoRi9u.png"],use_column_width=True)
    ...
    if language_selection:
        ...
        st.image(['https://i.imgur.com/MXI5JgM.png'],use_column_width=True)
    ...
    st.markdown(
        """
        <div style="position: fixed; bottom: 0; left: 0; width: 100%; background-color: #562400; color: #FFFFFF; padding: 1px; text-align: center;">
