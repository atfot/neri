...
""", unsafe_allow_html=True)
    ...
    if st.session_state.screen_setting=='full':
        st.markdown(
            """
            <div style="position: fixed; bottom: 0; left: 0; width: 100%; background-color: #FFF5E9; color: #000000; padding: 1px; text-align: center;">
        ...
        st.markdown(
            """
            <div style="position: fixed; bottom: 0; left: 2.5%; width: 70%; background-color: #FFF5E9; color: #000000; padding: 1px; text-align: left;">
