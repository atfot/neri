...
if prompt := st.chat_input():
    ...
    system_prompt=f"""```
      ...
      '''
      - Psychotherapists can indirectly express information about the mentally ill person and themselves when absolutely necessary, but otherwise they cannot say anything about the patient and themselves
