...
if 'messages' not in st.session_state:
    ...
    with col2:
        hi=st.button('hi',use_column_width=True)
    ...
    st.markdown(
        """
        <div style="position: fixed; bottom: 0; left: 0; width: 100%; background-color: #00CED4; color: #FFFFFF; padding: 15px; text-align: center;">
